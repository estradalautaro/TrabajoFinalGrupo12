...
class Regla {
  ...
  public void cambiarEstado() {
    ...
    if (regla.puntajeInicial >= 200 && regla.estado == MaquinaEstados.NIVEL_2) { // Si el puntajeInicial es mayor o igual a 200, estando en MaquinaEstados.NIVEL_2, entonces
      regla.estado = MaquinaEstados.NIVEL_3;
      actualizarRegla();
    }
    if (regla.puntajeInicial >= 300 && regla.estado == MaquinaEstados.NIVEL_3) { // Si el puntajeInicial es mayor o igual a 300, estando en MaquinaEstados.NIVEL_3, entonces
